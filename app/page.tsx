...
import TypingEffect from '../src/components/typing-effect';
import Link from 'next/link';
import BlackHoleModel from '../src/components/3d-model';
import NavBar from '../src/components/nav-bar';
import ModelViewer from '../src/components/3d-model-viewer';
